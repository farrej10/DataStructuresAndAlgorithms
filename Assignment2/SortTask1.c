...
int  main(int argc, char *argv[])
{
    //arrays
    int ARRAYSIZE = 10000;
    int ARRAYSIZETASK1 = 10;
    int testTask11[ARRAYSIZE];
    int testTask12[ARRAYSIZE];
    int testTask13[ARRAYSIZE];
    int testTask14[ARRAYSIZE];
    int testTask15[ARRAYSIZE];
    ...
    uniquerandomFill(testTask11,ARRAYSIZE);
    RandomFill(testTask12,ARRAYSIZE);
    ascendingFill(testTask13,ARRAYSIZE);
    descendingFill(testTask14,ARRAYSIZE);
    uniformFill(testTask15,ARRAYSIZE);
    ...
    quickSortAndPrintArray(testTask11,ARRAYSIZETASK1);
    quickSortAndPrintArray(testTask12,ARRAYSIZETASK1);
    quickSortAndPrintArray(testTask13,ARRAYSIZETASK1);
    quickSortAndPrintArray(testTask14,ARRAYSIZETASK1);
    quickSortAndPrintArray(testTask15,ARRAYSIZETASK1);
